...
describe("Cart Properties:", () => {
  ...
  test("Total should default to 0.", () => expect(cart.total).toEqual(0));
});
...
describe("Cart Methods:", () => {
  ...
  test("addToCart should add car to cart", () => {
  ...
  test("removeFromCart should remove a car from cart", () => {
    cart.addToCart(cars[0]);
    cart.addToCart(cars[1]);
    cart.addToCart(cars[2]);
  ...
  test("checkout() should empty cart and make total 0", () => {
    cart.addToCart(cars[0]);
    cart.addToCart(cars[1]);
    cart.addToCart(cars[2]);
